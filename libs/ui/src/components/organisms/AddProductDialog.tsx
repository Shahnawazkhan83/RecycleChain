        ...
        <Form
          onSubmit={handleSubmit(async (data) => {
            ...
            if (status) {
              ...
              setOpen(false)
              toast("🎉 Product created successfully! Your contribution to a greener future starts now! 🌍");
            } else {
              toast("⚠️ Oops! Product creation failed. Please check your inputs and try again.");
            }
            setLoading(false)
          })}
        >
